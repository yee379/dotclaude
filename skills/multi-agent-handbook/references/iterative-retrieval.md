...
The 4-phase DISPATCH → EVALUATE → REFINE → LOOP pattern for discovering what context a
subagent actually needs. Load when dispatching subagents into an unfamiliar codebase.
