...
- Are new ADRs called out in the plan for significant decisions made during implementation? (Check against ADRs already generated by `plan-architect-review` — don't duplicate, but identify any gaps.)
