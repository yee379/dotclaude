...
After producing the test diagram, write a test plan file so it can be consumed as primary test input:
...
Write to `.claude/test-plans/{branch}-test-plan-{datetime}.md`:
